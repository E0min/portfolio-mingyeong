  ...
  return (
    <span
      ...
      style={{
        ...
        textShadow: isActive ? "0 0 8px rgba(220, 250, 219, 0.5)" /* 활성 시 글로우 */ : "none",
      }}
    >
      {children}
    </span>
...
export default function AboutSection() {
  ...
  return (
    <section id="about" className={styles.about}>
      ...
      <span className={styles.aboutLabel} style={{ left: "60.9%", top: "81.2%" }}>
        (coming soon)
      </span>
        ...
        <div className={styles.aboutText} style={{ position: "relative" }}>
          ...
          >
            ...
            <button
              ...
              className="relative block w-full cursor-pointer overflow-hidden border-none bg-transparent p-0"
