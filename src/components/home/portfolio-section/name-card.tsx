...
import { verticalColumns } from "./portfolio-data";
import type { CardData } from "./portfolio-data";

/* ── 개별 명함 카드 컴포넌트 (Figma 346:1422~1482 새 구조) ──
...
export default function NameCard({ card, index }: NameCardProps) {
  return (
    <motion.div
          ...
          <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", height: "100%" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div>
                ...
                {/* 南 葵 : みなみ あおい (Figma: Comfortaa+Noto Sans JP ~31px, Medium) */}
                <p
                  style={{
                    fontFamily:
            ...
            {/* ── 중단: 이름 + 직함 + 인용구 + 세로 텍스트 ── */}
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flex: 1, marginTop: "0.5em" }}>
              <div>
                {/* Minami Aoi (Figma: Pretendard ~19.4px) */}
                <p style={{ fontFamily: "'Pretendard', sans-serif", fontSize: "clamp(12px, 1.01vw, 19.4px)", lineHeight: "normal" }}>
                  Minami Aoi
                </p>
                {/* Lee Young Min */}
                <p style={{ fontFamily: "'Pretendard', sans-serif", fontSize: "clamp(12px, 1.01vw, 19.4px)", lineHeight: "normal" }}>
              ...
              <div style={{ display: "flex", gap: "2px", alignSelf: "stretch", alignItems: "flex-start", paddingTop: "0.5em" }}>
